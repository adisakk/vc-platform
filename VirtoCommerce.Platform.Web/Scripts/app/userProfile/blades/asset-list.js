...
.controller('platformWebApp.userProfile.assetListController', ['$scope', 'platformWebApp.assets.api', 'platformWebApp.bladeNavigationService', 'platformWebApp.dialogService', '$sessionStorage', 'platformWebApp.bladeUtils', 'platformWebApp.uiGridHelper',
            ...
            assets.query(
                {
                    ...
                    folderUrl: '/documents/'+blade.userId
                },
            function (data) {
            ...
            },
            {
                ...
                executeMethod: function () {
                    var newBlade = {
                        ...
                        controller: 'platformWebApp.userProfile.assetUploadController',
                        template: '$(Platform)/Scripts/app/userProfile/blades/asset-upload.tpl.html'
                    };
